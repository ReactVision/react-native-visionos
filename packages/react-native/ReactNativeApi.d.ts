 ...
 *
 * @generated SignedSource<<2eeed0512ed7c30c2d880062df0e4d98>>
 *
...
import type { FocusEvent as FocusEvent_2 } from "react-native"
import type { HostInstance as HostInstance_2 } from "react-native"
import type { LayoutChangeEvent as LayoutChangeEvent_2 } from "react-native"
import type { LayoutRectangle as LayoutRectangle_2 } from "react-native"
import type { PublicRootInstance as PublicRootInstance_2 } from "react-native"
import type { PublicTextInstance as PublicTextInstance_2 } from "react-native"
import * as React from "react"
import type { ScrollResponderType as ScrollResponderType_2 } from "react-native"
import { ScrollView as ScrollView_2 } from "react-native"
import type { ScrollViewProps as ScrollViewProps_2 } from "react-native"
import type { StyleProp as StyleProp_2 } from "react-native"
import type { ViewStyle as ViewStyle_2 } from "react-native"
...
declare const WindowManager: typeof WindowManager_default
declare const WindowManager_default: {
  getWindow: (id: string) => Window
  get supportsMultipleScenes(): boolean
}
declare const XR: typeof XR_default
declare const XR_default: {
  endSession: () => Promise<void>
  requestSession: (
    sessionId: string,
    userInfo: null | Object | undefined,
  ) => Promise<void>
}
...
declare type CellRendererProps<ItemT> = {
  ...
  readonly item: ItemT
  readonly style: StyleProp_2<ViewStyle_2>
...
declare type OptionalVirtualizedListProps = {
  ...
  ListFooterComponentStyle?: StyleProp_2<ViewStyle_2>
  ListHeaderComponent?: React.ComponentType<any> | React.JSX.Element
  ListHeaderComponentStyle?: StyleProp_2<ViewStyle_2>
  ...
  renderScrollComponent?: (props: ScrollViewProps_2) => React.JSX.Element
}
...
declare type ReactFabricType = {
  ...
  getPublicInstanceFromInternalInstanceHandle(
    internalInstanceHandle: InternalInstanceHandle,
  ): HostInstance_2 | null | PublicTextInstance_2
  getPublicInstanceFromRootTag(rootTag: number): null | PublicRootInstance_2
  isChildPublicInstance(parent: HostInstance_2, child: HostInstance_2): boolean
  render(
  ...
  sendAccessibilityEvent(handle: HostInstance_2, eventType: string): void
...
> {
  ...
  getScrollRef(): null | React.ComponentRef<typeof ScrollView_2> | undefined
  getScrollResponder(): null | ScrollResponderType_2 | undefined
  hasMore(): boolean
...
declare type VirtualizedListProps = Omit<
  ScrollViewProps_2,
  | "data"
  | "getItem"
  | "getItemCount"
...
declare class Window {
  ...
  open(props: null | Object | undefined): Promise<void>
  update(props: null | Object | undefined): Promise<void>
}
declare type WindowManager = typeof WindowManager
...
export {
  ...
  ActivityIndicator, // 3cad29be
  ActivityIndicatorProps, // d960bcd9
  Alert, // 5bf12165
  ...
  DrawerLayoutAndroid, // b5c24b28
  DrawerLayoutAndroidProps, // 63da4182
  ...
  KeyUpEvent, // bc6bd87b
  Keyboard, // 49414c97
  KeyboardAvoidingView, // b8c4060e
  KeyboardAvoidingViewProps, // 5d5b7295
  ...
  PressableProps, // 5d621e64
  PressableStateCallbackType, // 9af36561
  ProcessedColorValue, // 33f74304
  ProgressBarAndroid, // 782feeed
  ProgressBarAndroidProps, // 02181314
  ...
  RefreshControl, // 5a0bb67f
  RefreshControlProps, // 09286d5c
  ...
  Touchable, // da3239ee
  TouchableHighlight, // c19c8aa2
  TouchableHighlightProps, // 2cc665bc
  TouchableNativeFeedback, // fc866848
  TouchableNativeFeedbackProps, // cc2cd62f
  TouchableOpacity, // 8bb5a256
  TouchableOpacityProps, // f65d15b1
  TouchableWithoutFeedback, // 39070327
  TouchableWithoutFeedbackProps, // b847de29
  ...
  VirtualizedListProps, // 6059505d
  VirtualizedSectionList, // 9fd9cd61
  VirtualizedSectionListProps, // 5bb37c04
  WindowManager, // 7ed04515
